...
|-------------|------------------------|
| 🌐 **WordPress Website Hosting** | Host WordPress on AWS EC2 using LEMP Stack (Linux, Nginx, MySQL, PHP) <br> 🔗 [GitHub Repo](https://github.com/chopadevivek07/Wordpress-Website-Hosting) • ✍️ [Medium Blog](#) |
...
| 🐍 **Flask EC2 Deployment** | Deploy Flask apps using Gunicorn & NGINX on AWS EC2 <br> 🔗 [GitHub Repo](https://github.com/chopadevivek07/Flask-EC2-Deployment) • ✍️ [Medium Blog](#) |
| 🗂️ **Task Manager – Flask RDS** | Flask web app integrated with AWS RDS (MySQL) <br> 🔗 [GitHub Repo](https://github.com/chopadevivek07/-Task-Manager---Flask-RDS) • ✍️ [Medium Blog](#) |
...
| ☁️ **Lambda File Upload Tutorial** | Serverless file upload using AWS Lambda, S3, and DynamoDB <br> 🔗 [GitHub Repo](https://github.com/chopadevivek07/Lambda-File-Upload-Tutorial) • ✍️ [Medium Blog](#) |
| 🌦️ **Serverless Weather Notification System** | Automate weather alerts using AWS Lambda, SNS & EventBridge <br> 🔗 [GitHub Repo](https://github.com/chopadevivek07/Serverless-Weather-Notification-System-) • ✍️ [Medium Blog](#) |
| 🧰 **Node App Jenkins Freestyle Deployment** | Deploy Node.js app using Jenkins Freestyle Jobs <br> 🔗 [GitHub Repo](https://github.com/chopadevivek07/Node-App-Jenkins-Freestyle-Deployment) • ✍️ [Medium Blog](#) |
| 📧 **Jenkins Email Notification & Git Clone Job** | Configure Jenkins SMTP email alerts and automate Git repo cloning job with success & failure notifications <br> 🔗 [GitHub Repo](https://github.com/chopadevivek07/Jenkins-Email-Notification-Git-Clone-Job) • ✍️ [Medium Blog](#) |
| 💾 **AWS EBS Volume Management Project** | Manage, attach, and mount AWS Elastic Block Store (EBS) volumes to EC2 instances <br> 🔗 [GitHub Repo](https://github.com/chopadevivek07/AWS-EBS-Volume-Management-Project) • ✍️ [Medium Blog](#) |
